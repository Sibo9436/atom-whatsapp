...
const {opacify, decomposeHEX, stringifyColor} = require('./utils.js');
...
export default class AtomWhatsappView {
  ...
  constructor(serializedState) {
    ...
    this.setColors = () => {
      ...
      let atom_bg = stringifyColor(decomposeHEX((style.getPropertyValue('--atom-app-background-color'))));
      // console.log(atom_bg);
      let atom_bg_error = opacify(style.getPropertyValue('--atom-background-color-error'), atom_bg);
      let atom_bg_highlight = opacify(style.getPropertyValue('--atom-background-color-highlight'), atom_bg);
      let atom_bg_info = opacify(style.getPropertyValue('--atom-background-color-info'), atom_bg);
      let atom_bg_selected = opacify(style.getPropertyValue('--atom-background-color-selected'), atom_bg);
      let atom_bg_success = opacify(style.getPropertyValue('--atom-background-color-success'), atom_bg);
      let atom_bg_warning = opacify(style.getPropertyValue('--atom-background-color-warning'), atom_bg);
      let atom_fg = opacify(style.getPropertyValue('--atom-text-color'), atom_bg);
      let atom_fg_error = opacify(style.getPropertyValue('--atom-text-color-error'), atom_bg);
      let atom_fg_highlight = opacify(style.getPropertyValue('--atom-text-color-highlight'), atom_bg);
      let atom_fg_info = opacify(style.getPropertyValue('--atom-text-color-info'), atom_bg);
      let atom_fg_selected = opacify(style.getPropertyValue('--atom-text-color-selected'), atom_bg);
      let atom_fg_subtle = opacify(style.getPropertyValue('--atom-text-color-subtle'), atom_bg);
      let atom_fg_success = opacify(style.getPropertyValue('--atom-text-color-success'), atom_bg);
      ...
      return `body{
        ...
        --border-strong-rgb:${atom_bg} !important;
        --border-stronger:rgb(${atom_bg}) !important;
        --border-stronger-rgb:${atom_bg} !important;
