...
export default class AtomWhatsappView {
  ...
  constructor(serializedState) {
    // Pre-define devtools function
    // this.devTools = () => console.log("Pre definition of function to open devtools");
    // Create root element
    ...
    this.element.addEventListener('ipc-message',(message)=>{
      ...
      <div class="block">
        <img class="inline-block" src="${notificationData.icon}" style="border-radius:50%;" >
        <div class="inline-block text-smaller">${notificationData.body}</div>
      </div>`;
    ...
    this.element.addEventListener('dom-ready',(e)=>{
      // this.devTools = () => this.element.openDevTools();
      // console.log("Defined function to open devtools");
