  ...
  constructor(serializedState) {
    ...
    this.element.addEventListener('dom-ready',(e)=>{
      ...
      this.element.insertCSS(`body{
        ...
        --background-active:${style.getPropertyValue('--atom-background-color-selected')} !important;
        --background-hover:${style.getPropertyValue('--atom-background-color-selected')} !important;
        --rich-text-panel:${style.getPropertyValue('--atom-app-background-color')} !important;
