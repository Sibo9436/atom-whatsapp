...
export default class AtomWhatsappView {
  ...
  constructor(serializedState) {
    ...
    this.element.preload=(atom.config.get('atom-whatsapp.notificationBehaviour')==='show')?__dirname+ "/preload.js":__dirname+ "/reply-preload.js";
    this.element.addEventListener('ipc-message',(message)=>{
      ...
      //TODO:Ricordarsi di levare loremPICSUM pls
      ...
      <div class="block">
        <div class="block">
        <img class="inline-block-tight" src="${notificationData.icon||"https://picsum.photos/200"}" style="border-radius:50%;width:50px;" >
        <div class="inline-block-tight text-smaller">${notificationData.body}</div>
        </div>
        ${atom.config.get('atom-whatsapp.notificationBehaviour')==='reply'&&`<input id="whatsapp-message" class="message input-text" type='text' placeholder='Answer me'/>`}
