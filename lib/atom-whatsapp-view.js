...
function rgbaArray(rgba) {
  ...
  var colorArr = [];
  var colorPH = "";
  for (i = indexOf('(') + 1; i < indexOf(','); i++) {
    colorPH += rgba[i];
  }
  colorArr[0] = parseInt(colorPH);
  colorPH = "";
  rgba = rgba.substr(i);
  for (i = 0; i < indexOf(','); i++) {
    colorPH += rgba[i];
  }
  colorArr[1] = parseInt(colorPH);
  colorPH = "";
  rgba = rgba.substr(i);
  for (i = 0; i < indexOf(','); i++) {
    colorPH += rgba[i];
  }
  colorArr[2] = parseInt(colorPH);
  colorPH = "";
  i++;
  for (; i < indexOf(')'); i++) {
    colorPH += rgba[i];
  }
  colorArr[3] = parseFloat(colorPH);
  return colorArr;
}
...
function makeOpaque(color) {
  var isRgba = color[0] == 'r' && color[1] == 'g' && color[2] == 'b' && color[3] == 'a';
  var isTransparentHex = color[0] == '#' && color.length() == 9;
  if (!(isRgba || isTransparentHex)) {
    exit(0);
  } else {
    if (isRgba) {
    ...
    this.element.addEventListener('dom-ready',(e)=>{
      ...
      this.element.insertCSS(`body{
        ...
        --unread-background:${style.getPropertyValue('--atom-app-background-color')} !important;
	      ...
	      --drawer-background:${style.getPropertyValue('--atom-app-background-color')} !important;
	      ...
	      --app-background:${style.getPropertyValue('--atom-app-background-color')} !important;
        --checkbox-mark:${style.getPropertyValue('--atom-app-background-color')} !important;
        --button-alternative-background:${style.getPropertyValue('--atom-app-background-color')} !important;
        --status-background:${style.getPropertyValue('--atom-app-background-color')} !important;
        --border-default:${style.getPropertyValue('--atom-app-background-color')} !important;
        ...
        --unread-marker-background:${style.getPropertyValue('--atom-background-color-selected')} !important;
	      ...
	      --avatar-placeholder-background:${style.getPropertyValue('--atom-background-color-selected')} !important;
	      --teal-pale:${style.getPropertyValue('--atom-background-color-selected')} !important;
	      --button-primary:${style.getPropertyValue('--atom-background-color-selected')} !important;
	      --button-secondary-background:${style.getPropertyValue('--atom-background-color-selected')} !important;
	      --button-secondary-background:${style.getPropertyValue('--atom-background-color-selected')} !important;
	      --button-secondary-hover:${style.getPropertyValue('--atom-background-color-selected')} !important;
	      --panel-background-deeper:${style.getPropertyValue('--atom-background-color-selected')} !important;
        ...
        --unread-bar-background:${style.getPropertyValue('--atom-background-color-highlight')} !important;
	      ...
	      --chevron-button-background:${style.getPropertyValue('--atom-background-color-highlight')} !important;
	      --button-primary-hover:${style.getPropertyValue('--atom-background-color-highlight')} !important;
	      --shadow-light:${style.getPropertyValue('--atom-background-color-highlight')} !important;
        ...
        --quick-action-button:${style.getPropertyValue('--atom-text-color')} !important;
	      ...
	      --avatar-placeholder-primary:${style.getPropertyValue('--atom-text-color')} !important;
	      --button-round-background:${style.getPropertyValue('--atom-text-color')} !important;
	      --input-border-active:${style.getPropertyValue('--atom-text-color')} !important;
	      --button-alternative:${style.getPropertyValue('--atom-text-color')} !important;
	      --status-secondary:${style.getPropertyValue('--atom-text-color')} !important;
	      --status-secondary-stronger:${style.getPropertyValue('--atom-text-color')} !important;
	      --system-message-text:${style.getPropertyValue('--atom-text-color')} !important;
        ...
        --butterbar-connection-secondary:${style.getPropertyValue('--atom-text-color-highlight')} !important;
	      ...
	      --active-tab-marker:${style.getPropertyValue('--atom-text-color-highlight')} !important;
	      --intro-border:${style.getPropertyValue('--atom-text-color-highlight')} !important;
	      --checkbox-background:${style.getPropertyValue('--atom-text-color-highlight')} !important;
	      --status-primary:${style.getPropertyValue('--atom-text-color-highlight')} !important;
	      --button-primary-background:${style.getPropertyValue('--atom-text-color-highlight')} !important;
	      --button-secondary:${style.getPropertyValue('--atom-text-color-highlight')} !important;
	      --button-secondary-background-hover:${style.getPropertyValue('--atom-text-color-highlight')} !important;
	      --highlight:${style.getPropertyValue('--atom-text-color-highlight')} !important;
